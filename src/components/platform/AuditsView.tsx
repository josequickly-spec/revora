...
type AuditSummary = {
  ...
  businessName: string | null; storageMode: "postgres";
...
type AuditDetail = {
  ...
  businessId: number | null; businessName: string | null; storageMode: "postgres";
  analysis: {
