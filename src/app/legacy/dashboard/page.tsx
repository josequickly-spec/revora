...
export default function LegacyCampaignDashboardPage() {
      ...
      <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-black text-xl text-white">EcoScale Partner</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-indigo-950/80 via-slate-900 to-purple-950/80 border border-indigo-500/40 rounded-2xl p-6 mb-8 shadow-xl">
          ...
          <p className="text-sm text-slate-300 mb-6 max-w-2xl">
            Coloca el nombre del negocio y EcoScale Partner generará automáticamente un análisis completo, funnel de ventas, estrategia de emails, análisis SEO y proyecciones de ROI.
          </p>
